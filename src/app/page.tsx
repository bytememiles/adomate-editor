    ...
    <div className='min-h-screen bg-background text-foreground'>
      ...
      <div className='lg:hidden fixed inset-0 bg-primary-50 flex items-center justify-center p-8 z-50'>
        <div className='text-center max-w-md'>
          <h1 className='text-2xl font-semibold text-primary-800 mb-4'>Desktop Only</h1>
      ...
      <div className='hidden lg:block'>
        <div className='max-w-7xl mx-auto px-8 py-12'>
          <header className='mb-12'>
            <h1 className='text-4xl font-bold text-primary-900 mb-4'>Adomate Editor</h1>
          ...
          <main className='space-y-8'>
            ...
            {/* Quick Actions */}
            <section className='bg-white rounded-lg shadow-sm border border-primary-200 p-6'>
              <h2 className='text-2xl font-semibold text-primary-800 mb-4'>Quick Actions</h2>
            ...
            {/* Color Palette Demo */}
            <section className='bg-white rounded-lg shadow-sm border border-primary-200 p-6'>
              <h2 className='text-2xl font-semibold text-primary-800 mb-4'>Color Palette</h2>
              <div className='grid grid-cols-5 gap-4'>
                {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((shade) => (
                  <div key={shade} className='text-center'>
                    <div
                      className='w-16 h-16 rounded-lg border border-primary-200 mx-auto mb-2'
